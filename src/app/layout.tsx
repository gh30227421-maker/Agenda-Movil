        ...
        <ToastProvider>
          <AuthProvider>
            <AuthGuard>
              <AgendaProvider>
                <RentabilityProvider>
                  <div className="min-h-screen flex flex-col relative z-10 pt-28">
                    <Header />
                    <main className="flex flex-col w-full flex-1 pt-6 lg:pt-8 px-6 lg:px-10 pb-8 bg-slate-50 print:p-0 [.presentation-mode-active_&]:p-0">
                      {children}
                    </main>
