...
interface CostosParticipacionAgenciaChartProps {
  events: any[];
}

export default function CostosParticipacionAgenciaChart({ events }: CostosParticipacionAgenciaChartProps) {
  ...
  const chartData = [
    { name: 'Agencia Móvil', value: stats.pct },
    ...
    <>
      ...
      >
        ...
        <div className="w-full flex items-center justify-between mb-2 px-1">
          <h4 className="text-sm font-bold text-[#00205B]">Agencia Móvil</h4>
          <div className="flex items-center gap-1 hide-on-download">
            <button 
              onClick={() => downloadImage(cardRef, 'Participacion_Costos_Agencia_Movil')}
        ...
        <div className="relative w-44 h-44 my-1">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center pointer-events-none">
            <span className="text-3xl font-black text-[#00205C]">{stats.pct}%</span>
      ...
      {/* Modal a Pantalla Completa para Agencia Móvil */}
      {isExpanded && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 sm:p-8">
          <div ref={modalRef} className="bg-white rounded-3xl w-full max-w-4xl flex flex-col shadow-2xl relative animate-in fade-in zoom-in duration-200 p-8">
            <div className="flex items-center justify-between pb-6 border-b border-gray-100 mb-6">
              <div>
                <h2 className="text-2xl font-bold text-[#00205B]">Participación Costos: Agencia Móvil</h2>
              ...
              <div className="flex items-center gap-2 hide-on-download">
                <button 
                  onClick={() => downloadImage(modalRef, 'Participacion_Costos_Agencia_Movil_HD')}
            ...
            <div className="flex flex-col items-center justify-center py-8">
              <div className="relative w-80 h-80 my-4">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center pointer-events-none">
                  <span className="text-6xl font-black text-[#00205C]">{stats.pct}%</span>
